...
function RequestModal({ onClose }: { onClose: () => void }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.message === "already_submitted") {
        setStatus("duplicate");
      } else {
        setStatus("success");
      }
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="req-modal-form">
              <div className="req-field">
                <label htmlFor="req-name">Your name <span className="req-optional">(optional)</span></label>
                <input
                  id="req-name"
                  type="text"
              ...
              <div className="req-field">
                <label htmlFor="req-email">Email address <span className="req-required">*</span></label>
                <input
                  id="req-email"
                  type="email"
              ...
              {status === "error" && (
                <p className="req-error">{errorMsg}</p>
              )}
              <button
                type="submit"
            ...
            <p className="req-modal-note">
              Already have an account? <Link to="/login" onClick={onClose}>Log in here.</Link>
            </p>
          </>
        )}
      </div>
